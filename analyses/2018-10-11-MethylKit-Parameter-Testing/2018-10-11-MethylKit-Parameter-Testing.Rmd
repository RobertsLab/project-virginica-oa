...
for(i in 1:length(fileName$sample.ID)) { #For each sample
...
```{r}
write.csv(diffMethStats50Cov1, "2018-10-14-Steven-Samples/2018-10-11-Steven-Samples-Differentially-Methylated-Loci-50-Cov1.csv") #Save table as .csv
```
...
```{r}
write.csv(diffMethStats50Cov3, "2018-10-14-Steven-Samples/2018-10-11-Steven-Samples-Differentially-Methylated-Loci-50-Cov3.csv") #Save table as .csv
```
...
```{r}
write.csv(diffMethStats50Cov5, "2018-10-14-Steven-Samples/2018-10-11-Steven-Samples-Differentially-Methylated-Loci-50-Cov5.csv") #Save table as .csv
```
