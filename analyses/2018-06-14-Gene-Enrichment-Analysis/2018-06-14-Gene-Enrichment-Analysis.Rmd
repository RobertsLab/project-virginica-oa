...
`compGO` provides both reports (found [here](2018-09-16-compGO-Output/)) and visualizations, using a p-value cutoff of 1e-2. Both output formats provide umbrella GOterms, that are then mapped to other GOterms. It's much easy to understand how enriched processes are represented in this way. Overrepresented biological processes include cytoskeletal growth and reorganization, transcription and translation regulation, and metabolic processes.
